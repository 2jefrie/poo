...
public class Main {
    public static void main(String[] args) {
        Estudiante estudiante1 = new Estudiante(1, "Cesar", "Paz", new Date(), Estudiante.Estado.MATRICULADO);
        Estudiante estudiante2 = new Estudiante(2, "Cecilia", "Sun", new Date(), Estudiante.Estado.INACTIVO);
